      ...
      <div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
        ...
        <div className="sm:col-span-8 lg:col-span-7">
          ...
          <div className="flex w-full pt-4">
            <h4 className="font-bold text-[18px] text-[#333] font-Roboto">${productData[0].discount_price}</h4>
            <h3 className="font-[500] text-[16px] text-[#d55b45] pl-3 mt-[-4px] line-through">{productData[0].price ? "$" + productData[0].price : null}</h3>
          </div>

          <div className="flex items-center pt-5 justify-around">
          <div className="flex ">
            <Button variant={"outline"} className="hover:bg-primary rounded-none hover:text-white" onClick={incrementCount}>+</Button>
            <Button variant={"outline"} className="px-8 rounded-none hover:bg-white cursor-default">{count }</Button>
            <Button variant={"outline"} className=" hover:bg-primary rounded-none hover:text-white" onClick={decrementCount}>-</Button>
          </div>
