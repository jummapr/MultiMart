...
const ProductDetail = () => {
    ...
    const [createConversation, {data, isSuccess, isLoading: isLoadingConversation}] = useCreateConversationMutation();
    console.log("data", data);
    console.log("COnversationId", data?.data?._id);
    ...
    const handleSubmitMessage = async () => {
        if (isAuthenticated) {
            const groupId = user?._id + "-" + productDetail?.data?.shop?._id;
            const userId = user?._id;
            const sellerId = productDetail?.data?.shop?._id;
    ...
    return (
        <div className="flex flex-col h-full w-full py-10 px-6 md:px-12 lg:px-40 xl:py-16 lg:py-16 md:py-16">
            <div
                className="grid h-full w-full grid-cols-1 gap-8 sm:gap-0 md:grid-cols-2 sm:grid-cols-2  lg:grid-cols-2 ">
                ...
                <div className="">
                    ...
                    <div className="flex gap-8 items-center ">
                        ...
                        <div
                            className="flex justify-center items-center bg-white w-8 h-8 text-center rounded-full hover:bg-primary hover:text-white transition-colors cursor-pointer">
